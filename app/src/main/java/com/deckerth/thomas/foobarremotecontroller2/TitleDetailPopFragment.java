 ...
 * on handsets.
 */
public class TitleDetailPopFragment extends Fragment {

    private FragmentTitleDetailPopBinding mBinding;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public TitleDetailPopFragment() {
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        mBinding = FragmentTitleDetailPopBinding.inflate(inflater, container, false);
